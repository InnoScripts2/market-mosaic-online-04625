...
> Хотите визуально усилить презентацию? Поместите изображения экранов в `public/screenshots` и добавьте ссылки на них в этот раздел. README подготовлен к подключению любой галереи — просто раскомментируйте блок ниже и замените пути.

<!--
![Главная панель](./public/screenshots/dashboard.png)
*Главный экран с ключевыми индексами, лидерами роста и лентой новостей.*

![Виджет активности](./public/screenshots/activity-widget.png)
*Пример модульной карточки: тепловая карта инструментов, которую легко заменить своими данными.*

![Мобильная версия](./public/screenshots/mobile.png)
